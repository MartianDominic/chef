...
export function Header({ hideSidebarIcon = false }: { hideSidebarIcon?: boolean }) {
  ...
  return (
    <header
      className={
        'flex h-[var(--header-height)] items-center overflow-x-auto overflow-y-hidden border-b border-[var(--cvx-border-transparent)] bg-[var(--cvx-background-primary)] p-5'
      }
    >
      <div className="z-40 flex cursor-pointer items-center gap-4 text-content-primary">
        ...
        <a href="/">
          {/* Tevero logo */}
          <img src="/logo.png?v=2" alt="Tevero" height={32} className="h-8 w-auto" />
        </a>
      </div>
      <>
        {chat.started && (
            ...
            <div className="ml-auto flex items-center gap-2">
              ...
              {profile && (
                ...
                >
                  ...
                  {/* Discord button commented out - links to Convex Discord
